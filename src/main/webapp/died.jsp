...
<head>
    ...
    <title>Action Survival - Died</title>
...
<div class="container mt-5">
    ...
    <h1 class="display-4 text-center fw-bold">Неудача. Вы умерли</h1>
    ...
    <form action="${pageContext.request.contextPath}/play-the-game" method="POST" class="mt-3">
        ...
        <button type="submit" class="btn btn-primary btn-lg">Начать сначала</button>
