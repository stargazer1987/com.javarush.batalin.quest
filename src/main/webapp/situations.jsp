...
<head>
    ...
    <title>Survival Horror - Try to survive</title>
...
<div class="container mt-5">
    ...
    <p class="mt-4 fs-4">${situation.situation}</p>
        ...
        <c:forEach var="entry" items="${situation.answers.entrySet()}">
            <div class="form-check">
                ...
                <label class="form-check-label" for="${entry.key}">
                        ${entry.key}. ${entry.value.answerText}
                </label>
            </div>
        </c:forEach>
    ...
    <div class="mt-5">
        <p class="h6 text-start">№ of Games Played: ${sessionScope.gameCount}</p>
    </div>
</div>
</body>
</html>
